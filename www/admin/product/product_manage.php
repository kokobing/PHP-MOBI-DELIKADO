...
$strSQL = "SELECT productinfo.id_prodinfo,productinfo.id_proddir,productdir.name,productinfo.title,productinfo.content,productinfo.ordernum,productdir.lang FROM productinfo left join productdir on productinfo.id_proddir=productdir.id_proddir WHERE productinfo.dele='1' $str order by productinfo.ordernum DESC" ;
            ...
            <tr>
              ...
              <table width="100%" border="0" cellspacing="3" cellpadding="0" >
                  ...
                  <tr>
                    ...
                    <td width="13%" align="center"><a href="javascript:void(0)" ><img src=getqrcode.php?pid=<?=$arrproductinfos[$i][id_prodinfo];?>&pdir2=<?=$arrproductinfos[$i][id_proddir];?>&lang=<?=$arrproductinfos[$i][lang];?>&ecc=Q&size=1   onclick="$.wholepop.dialogClass ='style_1';popmessage('<img src=getqrcode.php?pid=<?=$arrproductinfos[$i][id_prodinfo];?>&pdir2=<?=$arrproductinfos[$i][id_proddir];?>&lang=<?=$arrproductinfos[$i][lang];?>&ecc=Q&size=4  />','<?php echo cutstr($arrproductinfos[$i][title],30,1);?>')" /></a></td>
...
<?php }?>
   ...
   $strSQL="SELECT productinfo.*,productdir.name,productdir.lang,productdir.fatherid FROM productinfo left join productdir on productinfo.id_proddir=productdir.id_proddir WHERE id_prodinfo=$onenewsid";
            ...
            <tr>
              ...
              <table width="100%" border="0" cellpadding="4" cellspacing="0" class="txt">
                  ...
                  <tr bgcolor="#FFFFFF">
                    ...
                    <td valign="top" bgcolor="#FFFFFF">产品标签</td>
